            ...
            <div class="col-12">
                <div class="material-card card">
                    <div class="card-header">
						<div class="pull-left">
							<h6 class="card-title mt-1">Product Categories</h6>
						</div>
						<div class="pull-right">
                            <a href="{{url('/admin/category/create')}}" class="btn btn-outline-info btn-sm"><i class="mdi mdi-plus-circle"></i> Create Category</a>
						</div>
					</div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach($categories as $category)
                                        <tr>
                                            ...
                                            <td>{{$category->subcategory->maincategory->name}}</td>
                                            ...
                                            @endif
                                            <td>
                                                <a href="{{url('admin/category/'. $category->id. '/edit')}}"><button class="btn btn-success btn-circle btn-sm"><i class="mdi mdi-pencil"></i></button></a>
                                                <button data-url="{{url('admin/category/'.$category->id)}}" class="btn-delete btn btn-danger btn-circle btn-sm" data-toggle="modal" data-target="#deleteModal"><i class="mdi mdi-delete"></i></button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
