                            ...
                            <tbody id="cartItem">
                                ...
                                <tr scope="row">
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        <a href="{{url('product/details/'.$product->id.'/'.$product->slug)}}">Edit</a> 
                                    </td>
                                    <td class="add_cart_price text-center">USD &#36; {{$cartItem->price}}</td>
                                    <td>
                                    ...
                                    <td class="add_cart_price_total text-center">USD &#36; {{$cartItem->total}}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-6">
                                <div class="cart_sum_content">
                                    <ul>
                                        <li>Sub-Total:<span>USD &#36;  {{Cart::subtotal()}}</span></li>
                                        <li>Shipping:<span>USD &#36;  50</span></li>
                                        <li class="sum_total">Total:<span>USD &#36;  {{Cart::total() + 50}}</span></li>
