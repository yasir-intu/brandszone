                    ...
                    <div class="registration_container">
                        ...
                        <div class="registration_form">
                            <form action="{{url('customer/register')}}" method="post">
                                ...
                                <div class="input_login_box">
                                    <div class="g-recaptcha" data-sitekey="6LddSfUUAAAAALfQWQOG1i9moAqp3718BLu8qE2Z"></div>
                        ...
                        <!-- <div class="login_with_social_container">
                            ...
                            <div class="login_with_social_button text-center">
                                <ul>
                                    <li><a class="facebook_login" href="#"><i class="fab fa-facebook-f"></i> Log In via Facebook</a></li>
                                    <li><a class="google_login" href="#"><i class="fab fa-google-plus-g"></i> Log In via Google+</a></li>
                                </ul>
                            </div>
                        </div> -->
                    </div>
