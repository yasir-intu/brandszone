...
@section('content')
    ...
    <li class="breadcrumb-item"><a href="{{url('admin/subcategory')}}">Subcategories</a></li>
    @endcomponent
            ...
            <div class="col-12">
                <div class="material-card card">
                    <div class="card-header">
						<div class="pull-left">
							<h6 class="card-title mt-1">Product Subcategories</h6>
						</div>
						<div class="pull-right">
                            <a href="{{url('/admin/subcategory/create')}}" class="btn btn-outline-info btn-sm"><i class="mdi mdi-plus-circle"></i> Create Subcategory</a>
						</div>
					</div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach($subcategories as $subcategory)
                                        <tr>
                                            ...
                                            <td>{{$subcategory->categories->count()}}</td>
                                            ...
                                            @endif
                                            <td>
                                                <a href="{{url('admin/subcategory/'. $subcategory->id. '/edit')}}"><button class="btn btn-success btn-circle btn-sm"><i class="mdi mdi-pencil"></i></button></a>
                                                <button data-url="{{url('admin/subcategory/'.$subcategory->id)}}" class="btn-delete btn btn-danger btn-circle btn-sm" data-toggle="modal" data-target="#deleteModal"><i class="mdi mdi-delete"></i></button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
